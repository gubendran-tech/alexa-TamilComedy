...
var stateHandlers = {
    startModeIntentHandlers : Alexa.CreateStateHandler(constants.states.START_MODE, {
        ...
        'LaunchRequest' : function () {
            ...
            var message = "Welcome to the Tamil Comedy. Please choose the comedy from the list. " +
            	"1 Goundamani Comedy, 2 Vadivel Winner Movie Comedy 3 Santhanam Boss engira Baskaran Movie Comedy";
            var reprompt = 'You can say, play the tamil comedy, to begin.';

            this.response.speak(message).listen(reprompt);
            this.emit(':responseReady');
        },
        'ListAudio' : function() {
        	var message = "Please choose the comedy from the list. ' + " +
        			"'1 Goundamani Comedy, 2 Vadivel Winner Movie Comedy 3 Santhanam Boss engira Baskaran Movie Comedy';";
        	var reprompt = "please choose the comedy from the list. " + 
        	"'1 Goundamani Comedy, 2 Vadivel Winner Movie Comedy 3 Santhanam Boss engira Baskaran Movie Comedy";
        ...
        'PlayAudio' : function () { 
            ...
            console.log("In PlayAudio function:: slot:" +itemName);
            
        	if (itemName === '1' || itemName === 'Goundamani' || itemName === 'Gowndamani') {
                ...
                /* this.attributes['loop'] = true;
                 ...
                 //  Change state to START_MODE
                 this.handler.state = constants.states.START_MODE;
        	} else if (itemName === '2' || itemName === 'Vadivel' || itemName === 'Vadivelu') {
        		 this.attributes['playOrder'] = 1;
        ...
        'AMAZON.HelpIntent' : function () {
            var message = 'Welcome to the Tamil Comedy. You can say, play the comedy to begin the tamil comedy.';
        ...
        'Unhandled' : function () {
            var message = 'Sorry, I could not understand. Please say, play the comedy, to begin the comedy.';
            this.response.speak(message).listen(message);
            this.emit(':responseReady');
        }
    }),
    playModeIntentHandlers : Alexa.CreateStateHandler(constants.states.PLAY_MODE, {
        ...
        'LaunchRequest' : function () {
            ...
            if (this.attributes['playbackFinished']) {
                this.handler.state = constants.states.START_MODE;
                message = 'Welcome to the Tamil Comedy. You can say, play the comedy to begin the tamil comedy.';
                reprompt = 'You can say, play the tamil comedy, to begin.';
            } else {
        ...
        'AMAZON.HelpIntent' : function () {
            ...
            var message = 'You are listening to the Tamil comedy. You can say, Next or Previous to navigate through the playlist. ' +
                'At any time, you can say Pause to pause the comedy and Resume to resume.';
            this.response.speak(message).listen(message);
            this.emit(':responseReady');
        },
        'SessionEndedRequest' : function () {
...
function getSlotValue(event, slot) {
